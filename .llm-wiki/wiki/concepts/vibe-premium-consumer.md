...
- ❌ Inter, Roboto, Arial, Open Sans, Helvetica — use Geist, Clash Display, PP Editorial New
- ❌ Lucide, FontAwesome, Material Icons — use Phosphor Light, Remix Line
- ❌ 1px solid gray borders — use `border-white/[0.06-0.1]` dark, hairline on light
- ❌ Harsh shadows (`rgba(0,0,0,0.3)`)
- ❌ Symmetrical 3-column grids — vary with asymmetric bento
...
1. **Asymmetrical Bento** — masonry grid, vary col-span. Mobile: single column
