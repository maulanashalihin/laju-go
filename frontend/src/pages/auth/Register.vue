...
import { Lock, Mail, User, ArrowRight, Eye, EyeOff, Sparkles } from "lucide-vue-next";
...
<template>
  ...
  >
    ...
    <p class="mt-6 text-center text-sm text-neutral-600 dark:text-neutral-400">
      ...
      <Link href="/login" class="text-brand-600 hover:text-brand-700 dark:text-brand-400 dark:hover:text-brand-300 font-medium transition-colors">Sign in</Link>
    </p>
  </AuthLayout>
</template>
