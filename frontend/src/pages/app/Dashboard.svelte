    ...
    <div class="relative max-w-5xl mx-auto px-6 py-12">
        ...
        >
            <div class="flex items-center gap-4">
                <div
                    class="w-16 h-16 rounded-2xl bg-gradient-to-br from-orange-500 to-purple-500 flex items-center justify-center shadow-2xl shadow-orange-500/20"
                >
                    <svg
        ...
        >
            ...
            <div class="grid sm:grid-cols-2 gap-4">
                <a
                    ...
                    target="_blank"
                    class="flex items-center gap-3 p-4 rounded-xl bg-white/50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 hover:border-orange-500/30 transition-all group"
                >
                    <div
                        class="w-10 h-10 rounded-lg bg-orange-500/10 flex items-center justify-center group-hover:bg-orange-500/20 transition-colors"
                    >
                        <svg
                            class="w-5 h-5 text-orange-400"
                            fill="none"
