...
const { title, subtitle, pageTitle, headline, subheadline, stats, flash } =
  defineProps<Props>();
</script>
  ...
  <section class="min-h-screen bg-white dark:bg-neutral-950 flex">
    ...
    <div class="hidden lg:flex lg:w-1/2 relative items-center justify-center p-12">
      <div class="relative z-10 max-w-lg">
        ...
        <div v-if="stats && stats.length > 0" class="mt-12 grid grid-cols-3 gap-6">
      ...
      <div class="w-full max-w-md">
        ...
        >
          <div class="text-center mb-8">
            ...
            <p v-if="subtitle" class="text-neutral-600 dark:text-neutral-400 mt-2">{{ subtitle }}</p>
          </div>
