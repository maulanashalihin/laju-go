...
```bash
# Svelte (default)
npx create-laju-go@latest my-app

# React
npx create-laju-go@latest my-app --template react

# Vue
npx create-laju-go@latest my-app --template vue
```

Pass `--template svelte|react|vue` to skip the interactive prompt. Without the flag, the installer asks which frontend you want.
